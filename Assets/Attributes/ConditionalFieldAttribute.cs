...
public class ConditionalFieldAttribute : PropertyAttribute
{
    ...
    public ConditionalFieldAttribute(string conditionalSourceField, bool hideInInspector, bool inverse)
    {
        this.ConditionalSourceField = conditionalSourceField;
        this.HideInInspector = hideInInspector;
    ...
    public ConditionalFieldAttribute(bool hideInInspector = false)
    {
    ...
    public ConditionalFieldAttribute(string[] conditionalSourceFields,bool[] conditionalSourceFieldInverseBools, bool hideInInspector, bool inverse)
    {
    ...
    public ConditionalFieldAttribute(string[] conditionalSourceFields, bool hideInInspector, bool inverse)
    {
        this.ConditionalSourceFields = conditionalSourceFields;        
        this.HideInInspector = hideInInspector;
        this.Inverse = inverse;
